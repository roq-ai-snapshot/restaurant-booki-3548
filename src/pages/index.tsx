  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Your Table, Our Dedicated Staff Manages Reservations and Menus for a Seamless Service"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Restaurant Booking Engine - Streamlining Your Dining Experience. Reserve Your Table, Our Dedicated Staff Manages Reservations and Menus for a Seamless Service`}
            </Text>
            <Box
